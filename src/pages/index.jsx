        ...
        <>
            ...
            <div className={styles.content}>
                ...
                <main>
                    ...
                    <p className={styles.p}>Pour finir, vous trouverez le compte-rendu de la conférence des Rendez-vous de l'Histoire sur l'École des Chartes <a className={`${styles.toujours} ${styles.a}`} href="/ecole-des-chartes"> (non encore mis en place non plus) en cliquant ici</a>.</p>
